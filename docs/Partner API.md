...
| Trusted Network | A Trusted Network is needed in order to use the Qredo network, including the creation of funds and the movement of assets. A Trusted Network lets you add other Trusted Parties. These can include other companies, e.g., exchanges for an institution. Users can also be Trusted Parties, e.g., those for the companies you created as Trusted Parties. You can also find various Trusted Parties (company and users), and delete a Trusted Party. Note that if you delete a Trusted Party if it has been assigned to a fund.|
