...
5. Type in your new password in **Set Password** according to the password strength requirements as shown in the box.
...
4. In the **Verify Email** screen, enter the code in **Email address validation code**. The code should promptly arrive at the email address you used for registering on Qredo. If you did not receive the validation code, click **Re-send code**.
...
7. Enter a new password in **Set password** according to the strength requirements.
